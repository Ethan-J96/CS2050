...
// string
  ...
  string_queue.enqueue("first string");
  string_queue.enqueue("second string");
  string_queue.enqueue("third string");
  string_queue.enqueue("fourth string");
  string_queue.debug_write(std::cout);

  std::cout << "Removing : " << string_queue.dequeue() << "\n";
  std::cout << "Removing : " << string_queue.dequeue() << "\n";
  std::cout << "Removing : " << string_queue.dequeue() << "\n";  
  std::cout << "Removing : " << string_queue.dequeue() << "\n";

  string_queue.enqueue("first string2");
  string_queue.enqueue("second string2");
  string_queue.enqueue("third string2");
  string_queue.enqueue("fourth string2");
  string_queue.debug_write(std::cout);

// double
  Queue<double> double_queue;
  double_queue.enqueue(1);
  double_queue.enqueue(2);
  double_queue.enqueue(3);
  double_queue.enqueue(4);
  double_queue.debug_write(std::cout);

  std::cout << "Removing : " << double_queue.dequeue() << "\n";
  std::cout << "Removing : " << double_queue.dequeue() << "\n";
  std::cout << "Removing : " << double_queue.dequeue() << "\n";  
  std::cout << "Removing : " << double_queue.dequeue() << "\n";

  double_queue.enqueue(11);
  double_queue.enqueue(22);
  double_queue.enqueue(33);
  double_queue.enqueue(44);
  double_queue.debug_write(std::cout);
